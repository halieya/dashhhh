...
<button
      ...
      >
        {
          this.props.updated ===true ?  <p>update_vehicule</p>  :<p>ajouter_vehicule</p>
        }
...

      {
        ...
        <div>
          <input
            ...
            name="code"
            placeholder="code"
            value={this.props.vehicule.code}
        ...
        <div>
          <input
            ...
            name="type"
            placeholder="type"
            value={this.props.vehicule.type}
            onChange={e=> this.props.handleChange(e)}
          />
        </div>
        <div>
          <input
            ...
            value={this.props.vehicule.matricule}
            onChange={e=> this.props.handleChange(e)}
          />
        </div>
        <div>
          <input
            ...
            name="marque"
            placeholder=" mark"
            value={this.props.vehicule.marque}
            onChange={e=> this.props.handleChange(e)}
          />
        </div>
        ...
        <div>
          <input
            ...
            value={this.props.vehicule.filter}
            onChange={e=> this.props.handleChange(e)}
          />
        </div>
